		...
		public function defaults() {
			...
			//if the are no groups add the default groups
				...
				if (count($result) == 0) {
					...
					$array['groups'][$x]['group_uuid'] = uuid();
					$array['groups'][$x]['domain_uuid'] = null;
					$array['groups'][$x]['group_name'] = 'schooladmin';
					$array['groups'][$x]['group_level'] = '45';
					$array['groups'][$x]['group_description'] = 'School Group';
					$array['groups'][$x]['group_protected'] = 'false';
					$group_uuids[$array['groups'][$x]['group_name']] = $array['groups'][$x]['group_uuid'];
					$x++;
					$array['groups'][$x]['group_uuid'] = uuid();
					$array['groups'][$x]['domain_uuid'] = null;
					$array['groups'][$x]['group_name'] = 'schoolteacher';
					$array['groups'][$x]['group_level'] = '40';
					$array['groups'][$x]['group_description'] = 'School Teacher Group';
					$array['groups'][$x]['group_protected'] = 'false';
					$group_uuids[$array['groups'][$x]['group_name']] = $array['groups'][$x]['group_uuid'];
					$x++;
					$array['groups'][$x]['group_uuid'] = uuid();
