...
echo "<iframe src='https://$_SESSION[domain_name]/webphone/Phone/index.php?server=$_SESSION[domain_name]&extension=$extension&password=$password&fullname=$contactName' width='100%' height='100%' frameborder='none'></iframe>";
echo "<br /><br />";
