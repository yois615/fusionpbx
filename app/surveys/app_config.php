<?php
	...
	//permission details
		$y = 0;
		$apps[$x]['permissions'][$y]['name'] = 'survey_view';
		$apps[$x]['permissions'][$y]['groups'][] = 'superadmin';
		$apps[$x]['permissions'][$y]['groups'][] = 'admin';
		$y++;
		$apps[$x]['permissions'][$y]['name'] = 'survey_add';
		$apps[$x]['permissions'][$y]['groups'][] = 'superadmin';
		//$apps[$x]['permissions'][$y]['groups'][] = 'admin';
		$y++;
		$apps[$x]['permissions'][$y]['name'] = 'survey_delete';
		$apps[$x]['permissions'][$y]['groups'][] = 'superadmin';
		//$apps[$x]['permissions'][$y]['groups'][] = 'admin';
		$y++;
		$apps[$x]['permissions'][$y]['name'] = 'survey_edit';
		$apps[$x]['permissions'][$y]['groups'][] = 'superadmin';
		//$apps[$x]['permissions'][$y]['groups'][] = 'admin';
		$y++;
		$apps[$x]['permissions'][$y]['name'] = 'survey_destinations';
		$apps[$x]['permissions'][$y]['groups'][] = 'superadmin';
		//$apps[$x]['permissions'][$y]['groups'][] = 'admin';
		$y++;
		$apps[$x]['permissions'][$y]['name'] = 'survey_all';
		$apps[$x]['permissions'][$y]['groups'][] = 'superadmin';
		//$apps[$x]['permissions'][$y]['groups'][] = 'admin';
		$y++;
		...
		$apps[$x]['destinations'][$y]['label'] = "surveys";
		$apps[$x]['destinations'][$y]['name'] = "surveys";
		$apps[$x]['destinations'][$y]['sql'] = "select survey_uuid as uuid, name as name, survey_uuid as destination, description as description from v_surveys";
		$apps[$x]['destinations'][$y]['where'] = "where domain_uuid = '\${domain_uuid}' ";
		$apps[$x]['destinations'][$y]['order_by'] = "name asc";
		$apps[$x]['destinations'][$y]['field']['uuid'] = "survey_uuid";
		...
		$apps[$x]['destinations'][$y]['select_value']['dialplan'] = "lua:survey.lua \${destination}";
		$apps[$x]['destinations'][$y]['select_value']['ivr'] = "menu-exec-app:lua survey.lua \${destination}";
		$apps[$x]['destinations'][$y]['select_label'] = "\${name}";

	//Votes
		$y = 0;
		$apps[$x]['db'][$y]['table']['name'] = 'v_survey_customer';
		$apps[$x]['db'][$y]['table']['parent'] = '';
		$z = 0;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'survey_customer_uuid';
		...
		$y++;
		$apps[$x]['db'][$y]['table']['name'] = 'v_survey_votes';
		$apps[$x]['db'][$y]['table']['parent'] = '';
		$z = 0;
		...
		$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = 'char(36)';
		$apps[$x]['db'][$y]['fields'][$z]['key']['type'] = 'foreign';
		$apps[$x]['db'][$y]['fields'][$z]['key']['reference']['table'] = 'v_survey_customer';
		$apps[$x]['db'][$y]['fields'][$z]['key']['reference']['field'] = 'survey_customer_uuid';
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'survey_uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = 'text';
		$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = 'char(36)';
		$apps[$x]['db'][$y]['fields'][$z]['key']['type'] = 'foreign';
		$apps[$x]['db'][$y]['fields'][$z]['key']['reference']['table'] = 'v_survey';
		$apps[$x]['db'][$y]['fields'][$z]['key']['reference']['field'] = 'survey_uuid';
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'domain_uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = 'text';
		...
		$y++;
		$apps[$x]['db'][$y]['table']['name'] = 'v_surveys';
		$apps[$x]['db'][$y]['table']['parent'] = '';
		$z = 0;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'survey_uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'uuid';
		...
		$y++;
		$apps[$x]['db'][$y]['table']['name'] = 'v_survey_questions';
		$apps[$x]['db'][$y]['table']['parent'] = 'v_surveys';
		$z = 0;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'survey_question_uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'uuid';
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = 'text';
		$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = 'char(36)';
		$apps[$x]['db'][$y]['fields'][$z]['key']['type'] = 'primary';
