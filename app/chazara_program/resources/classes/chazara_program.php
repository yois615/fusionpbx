...
if (!class_exists('chazara_program')) {
	class chazara_program {
		...
		public function __construct() {
			...
			//assign private variables
				$this->app_name = 'chazara_program';
				$this->app_uuid = '37a9d861-c7a2-9e90-925d-29e3c2e0b60e';
				$this->permission_prefix = 'chazara_';
				$this->list_page = 'chazara_program.php';
				$this->table = 'chazara_program';
				$this->uuid_prefix = 'chazara_';
